...
('bouton',       'bouton_io',           'svg',  'by_color',      'default',    'green'  ),
...
('voyant',       'voyant',              'svg',  'by_color',      'default',    'red'    ),
...
('bouton',       'switch',              'svg',  'by_mode',       'off',        'blue'   ),
('meteo',        'meteo',               'svg',  'by_mode',       'soleil',     'gray'   ),
('camera',       'cctv',                'svg',  'static',        'default',    'gray'   ),
