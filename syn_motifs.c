...
/******************************************** Préparation de la base du mnemo *************************************************/
    ...
    if ( !target_acro )
     { Info ( __func__, "synoptique", domain->uuid, LOG_ERR, "Normalize error for target_acro." ); }

    target_tech_id = Normaliser_chaine ( target_tech_id_src );                               /* Formatage correct des chaines */
    if ( !target_tech_id )
     { Info ( __func__, "synoptique", domain->uuid, LOG_ERR, "Normalize error for target_tech_id." ); }
