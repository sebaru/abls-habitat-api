#!/usr/bin/env bash
# =============================================================================
# 12-phidget-gpiod.sh - Tests des endpoints Phidget et GPIOd
# =============================================================================
# Endpoints testés: GET /phidget/list, POST /phidget/set, POST /phidget/set/io,
#                   GET /gpiod/list,   POST /gpiod/set,   POST /gpiod/set/io
# =============================================================================

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
source "${SCRIPT_DIR}/../lib/test-utils.sh"

log_suite "Suite 12 - Phidget et GPIOd"
...
PHI_IO_LIB=$(db_domain_query "SELECT libelle FROM phidget_IO WHERE thread_tech_id='TEST_PHIDGET' AND thread_acronyme='PHI_IO_01' LIMIT 1;")
_test_start
...
db_domain_query "UPDATE phidget_IO SET libelle='Entrée phidget test 01' WHERE thread_tech_id='TEST_PHIDGET' AND thread_acronyme='PHI_IO_01';" >/dev/null 2>&1 || true

# =============================================================================
# GPIOd
# =============================================================================
log_suite "Suite 12.b - GPIOd"
...
print_suite_summary "Suite 12 - Phidget et GPIOd"
[[ ${TESTS_FAILED} -eq 0 ]]
